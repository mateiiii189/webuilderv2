...
The Contact page displays the email address as selectable text in an outlined box without an arrow or click action, followed by a short WhatsApp invitation and a “Scrie-ne pe WhatsApp” outline button. It opens a WhatsApp conversation with a short draft greeting; the visitor sends it themselves. An empty or malformed number hides the button. No WhatsApp API credentials or messaging service are needed.
