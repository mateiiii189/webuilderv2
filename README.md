...
Sanity now powers editable portfolio projects through `/studio`. See [Sanity setup and publishing](docs/sanity.md). The blog uses the same Sanity project; see [blog publishing](docs/blog.md).
